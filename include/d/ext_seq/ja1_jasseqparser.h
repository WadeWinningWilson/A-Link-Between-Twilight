#ifndef D_EXT_SEQ_JA1_JASSEQPARSER_H
#define D_EXT_SEQ_JA1_JASSEQPARSER_H

// ============================================================
// §367 JAudio1 sequence-command parser — donor-verbatim port of WW
// retail JSystem/JAudio/JASSeqParser.h (D:/XXXXXXX/WW DP). Phase A2 of
// the native JA1 sequencer campaign (bus §362/§363). Namespace
// convention matches the §363 oscillator port: donor JASystem::*
// flattens into JAudio1::* with donor symbol names kept (§328
// same-name lesson). Body TU: src/d/ext_seq/ja1_jasseqparser.cpp
// (donor JASSeqParser.cpp).
// ============================================================
...
namespace JAudio1 {
    ...
    class TSeqParser {
    public:
        typedef int (TSeqParser::*CmdFunc)(JAudio1::TTrack*, u32*);
...
#endif /* D_EXT_SEQ_JA1_JASSEQPARSER_H */
