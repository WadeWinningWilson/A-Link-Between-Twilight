#ifndef D_EXT_SEQ_JA1_JASTRACK_H
#define D_EXT_SEQ_JA1_JASTRACK_H

// ============================================================
// §367 JAudio1 sequencer track — donor-verbatim port of WW retail
// JSystem/JAudio/JASTrack.h (D:/XXXXXXX/WW DP). Phase A2 of the native
// JA1 sequencer campaign (bus §362/§363). Namespace convention matches
// the §363 oscillator port: donor JASystem::* flattens into JAudio1::*
// with donor symbol names kept (§328 same-name lesson).
// Donor include map (§367, updated §368/A3):
//   JASRegisterParam.h / JASSeqCtrl.h /
//   JASTrackInterrupt.h / JASTrackPort.h / JUTAssert.h
//                      -> d/ext_seq/ja1_boundary.h (§367 boundary layer)
//   JASChannelMgr.h    -> d/ext_seq/ja1_jaschannel.h (§368 A3 — REAL
//                         donor TChannel/TChannelMgr; the A2 boundary
//                         silhouette is retired)
//   JASOscillator.h    -> d/ext_seq/ja1_oscillator.h (§363, already ported)
//   JASSeqParser.h     -> d/ext_seq/ja1_jasseqparser.h (A2)
// Donor JASOuterParamFlag sat at GLOBAL scope; wrapped into JAudio1
// here (§367 namespace wrap) — nothing outside the JA1 port consumes it.
// Body TU: src/d/ext_seq/ja1_jastrack.cpp (donor JASTrack.cpp).
// ============================================================

#include <cstddef>  // ===== §367: size_t for the donor pool operator new/delete

#include "d/ext_seq/ja1_boundary.h"
#include "d/ext_seq/ja1_jaschannel.h"  // ===== §368 A3: real donor TChannel/TChannelMgr (TTrack embeds TChannelMgr by value)
...
// ============================================================
// §370 NOTE — the A2-support TNoteMgr/TOuterParam stub fences that
// lived here were retired in A4.5; the nested classes above are
// donor-verbatim from JASTrack.h and their out-of-line bodies are now
// REAL:
//   TTrack::TNoteMgr    -> ja1_jasnotemgr.cpp   (donor JASNoteMgr.cpp)
//   TTrack::TOuterParam -> ja1_jasouterparam.cpp (donor JASOuterParam.cpp)
// ============================================================

}

#endif /* D_EXT_SEQ_JA1_JASTRACK_H */
