...
// ============================================================
// §232 WW seagull (d_a_kamome) DIRECT PORT — struct layout is VERBATIM from the
// WW donor (D:/XXXXXXX/WW DP/include/d/actor/d_a_kamome.h). No offsets changed;
// the .cpp applies the pig (d_a_kb) direct-port crash recipes at the call sites.
// ============================================================
