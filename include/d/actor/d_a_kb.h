...
#include "d/d_ext_ww_actor_shims.h"  // §225 dPa_ripple/smokeEcallBack no-op stand-ins
...
public:
    ...
    /* 0x83C */ dCcD_Sph mSph;
    /* 0x968 */ dCcD_Sph m968;
    // §231 P13 state-tap bookkeeping (appended after the donor layout; name-based access,
    // no donor offset impact). Last (action=m41E, mode=m420) emitted, for transition-only tap.
    s16 mDbgLastAction;
    s16 mDbgLastMode;
};
