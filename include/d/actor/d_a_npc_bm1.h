...
// §246 port: J3DNode/J3DJoint are not pulled by the d_npc.h/m_Do_ext.h chain (only
// J3DModel is); forward-declare for the node-callback method decls. The port's
// J3DJointCallBack is int(*)(J3DJoint*,int) and J3DJoint is NOT derived from
// J3DNode, so the node-control methods take J3DJoint* (was J3DNode* in the donor).
class J3DNode;
class J3DJoint;
...
public:
    ...
    void nodeWngControl(J3DJoint*, J3DModel*); // §246 J3DNode* -> J3DJoint* (port callback type)
    void nodeArmControl(J3DJoint*, J3DModel*); // §246 J3DNode* -> J3DJoint*
    void nodeBm1Control(J3DJoint*, J3DModel*); // §246 J3DNode* -> J3DJoint*
    bool chk_appCnd();
    bool init_PST_0();
    bool init_PST_1();
    bool init_PST_2();
