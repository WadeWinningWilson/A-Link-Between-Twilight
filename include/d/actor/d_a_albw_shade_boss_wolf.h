#ifndef D_A_ALBW_SHADE_BOSS_WOLF_H
#define D_A_ALBW_SHADE_BOSS_WOLF_H

#include "d/actor/d_a_npc4.h"

struct daAlbwShadeBossWolf_HIOParam {
...
class daAlbwShadeBossWolf_Param_c {
public:
    virtual ~daAlbwShadeBossWolf_Param_c() {}

    static daAlbwShadeBossWolf_HIOParam const m;
};

#if DEBUG
class daAlbwShadeBossWolf_HIO_c : public mDoHIO_entry_c {
public:
    daAlbwShadeBossWolf_HIO_c();

    void listenPropertyEvent(const JORPropertyEvent*);

    void genMessage(JORMContext*);

    /* 0x8 */ daAlbwShadeBossWolf_HIOParam m;
};

#define ALBW_SHADE_BOSS_WOLF_HIO_CLASS daAlbwShadeBossWolf_HIO_c
#else
#define ALBW_SHADE_BOSS_WOLF_HIO_CLASS daAlbwShadeBossWolf_Param_c
#endif

/**
 * @ingroup actors-npcs
 * @class daAlbwShadeBossWolf_c
 * @brief Golden Wolf
 *
 * @details
 *
*/
class daAlbwShadeBossWolf_c : public daNpcF_c {
public:
    typedef BOOL (daAlbwShadeBossWolf_c::*actionFunc)(void*);
    typedef BOOL (daAlbwShadeBossWolf_c::*cutFunc)(int);

    daAlbwShadeBossWolf_c();
    cPhs_Step create();
    int CreateHeap();
    int Delete();
    int Execute();
...
private:
    ...
    /* 0xC88 */ ALBW_SHADE_BOSS_WOLF_HIO_CLASS* mpHIO;
    /* 0xC8C */ dCcD_Cyl mCyl;
...
STATIC_ASSERT(sizeof(daAlbwShadeBossWolf_c) == 0xe20);

#endif /* D_A_ALBW_SHADE_BOSS_WOLF_H */
