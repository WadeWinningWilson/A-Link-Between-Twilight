...
// ============================================================
// §244 WW Aryll (NPC_LS1) DIRECT PORT — header verbatim from donor
// (D:/XXXXXXX/WW DP/include/d/actor/d_a_npc_ls1.h). Base class fopNpc_npc_c
// and every dNpc_* helper are now NATIVE (include/d/d_npc.h) — no shim.
// Only d_npc.h (native) is required by this header; all member types
// (J3DMaterialAnm, mDoExt_btkAnm/btpAnm, mDoHIO_entry_c, Mtx, cXyz, csXyz,
// request_of_phase_process_class) are already present in the port.
// ============================================================
...
public:
    ...
    void _nodeCB_Hand_L(J3DJoint*, J3DModel*);
    void _nodeCB_Hand_R(J3DJoint*, J3DModel*);
    void _Ls_hand_nodeCB_Hand_L(J3DJoint*, J3DModel*);
    void _Ls_hand_nodeCB_Hand_R(J3DJoint*, J3DModel*);
    bool init_LS1_0();
    bool init_LS1_1();
    bool init_LS1_2();
    bool init_LS1_3();
    ...
    BOOL _execute();
    BOOL _delete();
    cPhs_Step _create();  // §244 WW cPhs_State -> port cPhs_Step
    BOOL bodyCreateHeap();
    BOOL handCreateHeap();
    BOOL itemCreateHeap();
    BOOL CreateHeap();
