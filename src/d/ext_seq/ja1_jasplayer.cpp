...
// KIT-DONOR: JSystem/JAudio/JASPlayer_impl.cpp
// KIT-DONOR-REF: zeldaret/tww@1d57f0468986987ec26a3d1800bdc1aaad3794db
// KIT-DONOR-STATUS: Matching
// ============================================================
// �369 JAudio1 player rows � donor-verbatim port of the WW retail
// JSystem/JAudio/JASPlayer_impl.cpp REMAINDER (D:/XXXXXXX/WW DP; dtk
// address markers kept). Phase A4 of the native JA1 campaign (bus
// �362/�363/�366; History lane �369). The �363 oscillator port already
// carries this TU's envelope default tables (sAdsrDef/sEnvelopeDef/
// sVibratoDef/sTremoroDef + sAdsTable/sRelTable/sVibTable/sTreTable,
// ja1_oscillator.cpp) � this TU lands the rest: extend8to16,
// s_key_table, pitchToCent, getRandomS32, and the REAL
// CUTOFF_TO_IIR_TABLE data (512 s16 = 128 cutoff steps x 4 IIR coefs;
// retires the A2 zero-filled boundary placeholder).
// Donor JASystem::* flattens into JAudio1::* (�363 convention), donor
// symbol names kept. Table data extracted verbatim from the donor TU.
// Donor bug kept (�369): pitchToCent indexes
// Driver::C5BASE_PITCHTABLE[var3 + 0x3c] without clamping � extreme
// pitch offsets read past the 128-entry table exactly as on GC.
// Donor include map: JASPlayer.h -> ja1_boundary.h (Player rows);
// JASDriverTables.h -> ja1_dsp_boundary.h (C5BASE_PITCHTABLE, defined
// in ja1_jaschannel.cpp since A3).
// ============================================================
...
s16 Player::extend8to16(u8 param_1) {
    s16 var1 = param_1;
    if (param_1 & 0x80) {
        var1 += 0xFF00;
    }
...
const f32 Player::s_key_table[64] = {
...
f32 Player::pitchToCent(f32 param_1, f32 param_2) {
...
s16 Player::CUTOFF_TO_IIR_TABLE[512] = {
