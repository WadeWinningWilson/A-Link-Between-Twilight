/**
 * @file d_a_albw_shade_boss_wolf.cpp
 *
 * ============================================
...
#include "d/actor/d_a_albw_shade_boss_wolf.h"
#include "d/actor/d_a_npc.h"
#include "Z2AudioLib/Z2Instances.h"
#include "d/d_camera.h"
#include "SSystem/SComponent/c_math.h"  // cM_ssin/cM_scos (lookat + attack-warp blur)
#include "d/d_msg_object.h"        // Hero's Shade summon: native message text/select injection
...
static ALBW_SHADE_BOSS_WOLF_HIO_CLASS l_HIO;
...
char DUSK_CONST* DUSK_CONST daAlbwShadeBossWolf_c::mEvtCutNameList[5] = {
    "",
    "ATTACK_WARP",
    "ATTACK_WARP_HORSE",
    "HOWLING_SESSIONA",
...
daAlbwShadeBossWolf_c::cutFunc DUSK_CONST daAlbwShadeBossWolf_c::mEvtCutList[5] = {
    NULL,
    &daAlbwShadeBossWolf_c::ECut_attackWarp,
    &daAlbwShadeBossWolf_c::ECut_attackWarpHorse,
    &daAlbwShadeBossWolf_c::ECut_howlingSessionA,
    &daAlbwShadeBossWolf_c::ECut_meetGWolf,
};

daAlbwShadeBossWolf_HIOParam const daAlbwShadeBossWolf_Param_c::m = {
    30.0f,
    -4.0f,
    1.0f,
    600.0f,
...
#if DEBUG
daAlbwShadeBossWolf_HIO_c::daAlbwShadeBossWolf_HIO_c() {
    m = daAlbwShadeBossWolf_Param_c::m;
}

void daAlbwShadeBossWolf_HIO_c::listenPropertyEvent(const JORPropertyEvent* event) {
    // NONMATCHING
}

void daAlbwShadeBossWolf_HIO_c::genMessage(JORMContext* ctx) {
    // NONMATCHING
}
#endif

daAlbwShadeBossWolf_c::daAlbwShadeBossWolf_c() {}
...
cPhs_Step daAlbwShadeBossWolf_c::create() {
    fopAcM_ct(this, daAlbwShadeBossWolf_c);
...
int daAlbwShadeBossWolf_c::CreateHeap() {
...
int daAlbwShadeBossWolf_c::Delete() {
    fopAcM_GetID(this);
    this->~daAlbwShadeBossWolf_c();
    return 1;
}

int daAlbwShadeBossWolf_c::Execute() {
    return execute();
}

int daAlbwShadeBossWolf_c::Draw() {
    J3DModelData* mdlData_p = mAnm_p->getModel()->getModelData();
    mdlData_p->getMaterialNodePointer(2)->setMaterialAnm(mpMatAnm);

    return draw(
        chkAction(&daAlbwShadeBossWolf_c::test), FALSE, mpHIO->m.common.real_shadow_size, NULL, 0
    );
}

int daAlbwShadeBossWolf_c::draw(int param_1, int param_2, f32 param_3, GXColorS10* i_color, int param_5) {
    J3DModel* model = mAnm_p->getModel();
...
int daAlbwShadeBossWolf_c::ctrlJoint(J3DJoint* i_joint, J3DModel* i_model) {
...
int daAlbwShadeBossWolf_c::createHeapCallBack(fopAc_ac_c* a_this) {
    return static_cast<daAlbwShadeBossWolf_c*>(a_this)->CreateHeap();
}

int daAlbwShadeBossWolf_c::ctrlJointCallBack(J3DJoint* i_joint, int param_2) {
    if (param_2 == 0) {
        J3DModel* model = j3dSys.getModel();
        daAlbwShadeBossWolf_c* i_this = (daAlbwShadeBossWolf_c*)model->getUserArea();
...
void daAlbwShadeBossWolf_c::setParam() {
...
BOOL daAlbwShadeBossWolf_c::main() {
    if (!doEvent()) {
        doNormalAction(1);
    }
...
BOOL daAlbwShadeBossWolf_c::ctrlBtk() {
    if (mpMatAnm != NULL) {
...
void daAlbwShadeBossWolf_c::adjustShapeAngle() {
    s16 target = 0;
...
void daAlbwShadeBossWolf_c::setAttnPos() {
...
bool daAlbwShadeBossWolf_c::setExpressionAnm(int i_index, bool i_modify) {
    return true;
}

void daAlbwShadeBossWolf_c::setExpression(int i_index, f32 i_morf) {
    /* empty function */
}

void daAlbwShadeBossWolf_c::setMotionAnm(int i_index, f32 i_morf) {
...
void daAlbwShadeBossWolf_c::setMotion(int i_motion, f32 i_morf, int param_3) {
    s16 motion = i_motion;
...
BOOL daAlbwShadeBossWolf_c::drawDbgInfo() {
    return FALSE;
}

void daAlbwShadeBossWolf_c::drawOtherMdls() {
    /* empty function */
}

u8 daAlbwShadeBossWolf_c::getTypeFromParam() {
...
int daAlbwShadeBossWolf_c::getModeFromParam() {
...
BOOL daAlbwShadeBossWolf_c::isDelete() {
    // ============================================
    // NEW CODE — ALBW Port — "Shade's Refuge"
...
void daAlbwShadeBossWolf_c::reset() {
    initialize();
    mpMatAnm->initialize();
    mLookat.initialize();
...
void daAlbwShadeBossWolf_c::playMotion() {
...
BOOL daAlbwShadeBossWolf_c::chkAction(actionFunc action) {
    return mAction == action;
}

BOOL daAlbwShadeBossWolf_c::setAction(actionFunc action) {
    mMode = 3;
...
BOOL daAlbwShadeBossWolf_c::selectAction() {
    mNextAction = NULL;

    if (mpHIO->m.common.debug_mode_ON) {
        mNextAction = &daAlbwShadeBossWolf_c::test;
    } else {
        switch (mType) {
            case 2:
                mNextAction = &daAlbwShadeBossWolf_c::waitBrave;
                break;
                  
            case 1:
                mNextAction = &daAlbwShadeBossWolf_c::waitHowling;
                break;
...
void daAlbwShadeBossWolf_c::doNormalAction(int param_1) {
...
BOOL daAlbwShadeBossWolf_c::doEvent() {
    BOOL rv = FALSE;
    ...
    if (dComIfGp_event_runCheck()) {
        ...
        if (eventInfo.checkCommandTalk()) {
            if (chkAction(&daAlbwShadeBossWolf_c::talk)) {
                (this->*mAction)(NULL);
            } else if (dComIfGp_event_chkTalkXY() == FALSE || dComIfGp_evmng_ChkPresentEnd()) {
                setAction(&daAlbwShadeBossWolf_c::talk);
            }
...
void daAlbwShadeBossWolf_c::setLookMode(int i_lookMode) {
    if (i_lookMode >= 0 && i_lookMode < 5 && i_lookMode != mLookMode) {
        mLookMode = i_lookMode;
    }
}

void daAlbwShadeBossWolf_c::lookat() {
...
BOOL daAlbwShadeBossWolf_c::ECut_attackWarp(int i_staffId) {
    dEvent_manager_c& eventManager = dComIfGp_getEventManager();
    int iVar1 = 0;
...
BOOL daAlbwShadeBossWolf_c::ECut_attackWarpHorse(int i_staffId) {
    dEvent_manager_c& eventManager = dComIfGp_getEventManager();
    int iVar1 = 0;
    daPy_py_c* player = daPy_getPlayerActorClass();
    BOOL rv = FALSE;
...
BOOL daAlbwShadeBossWolf_c::ECut_howlingSessionA(int i_staffId) {
    dEvent_manager_c& eventManager = dComIfGp_getEventManager();
...
static BOOL callback_proc(void* i_actor, int i_data) {
    static_cast<daAlbwShadeBossWolf_c*>(i_actor)->meetGWolfSkip();
    return TRUE;
}

void daAlbwShadeBossWolf_c::meetGWolfSkip() {
    mOrderEvtNo = EVT_NONE;
    mEventIdx = -1;
    field_0xe1d = 1;
    dComIfGp_event_reset();
...
BOOL daAlbwShadeBossWolf_c::ECut_meetGWolf(int i_staffId) {
    dEvent_manager_c& eventManager = dComIfGp_getEventManager();
    daPy_getPlayerActorClass();
    int prm = -1;
    int* piVar1 = dComIfGp_evmng_getMyIntegerP(i_staffId, "prm");
...
BOOL daAlbwShadeBossWolf_c::wait(void* param_1) {
    switch (mMode) {
        case 0:
            setMotion(MOT_WAITSIT, -1.0f, 0);
            setLookMode(LOOK_NONE);
...
BOOL daAlbwShadeBossWolf_c::waitHowling(void* param_1) {
    switch (mMode) {
        case 0:
            setMotion(MOT_WAITSIT, -1.0f, 0);
            setLookMode(LOOK_PLAYER);
...
BOOL daAlbwShadeBossWolf_c::waitBrave(void* param_1) {
    switch (mMode) {
        case 0:
            setMotion(MOT_WAITSIT, -1.0f, 0);
            setLookMode(LOOK_PLAYER);
...
BOOL daAlbwShadeBossWolf_c::talk(void* param_1) {
    BOOL rv = FALSE;
    ...
    switch (mMode) {
        case 0: {
            ...
            // Native vanilla message box + 2-way selector, text injected at
            // runtime (no BMG asset). Select words/flag MUST be set AFTER
            // initWord (it clears them); the flag value == the choice count.
            // ============================================
            sShadeFlow.initWord(this,
                                "The Hero of Time has deemed you\n"
                                "worthy of one final trial.",
                                0xFF, 0, NULL);
            // Short labels — the native 2-way select box is one line, ~8 chars
            // wide (sized for the vanilla Yes/No), so "Test Your Will" overflowed.
            dMsgObject_setSelectWord(0, "Duel");
            dMsgObject_setSelectWord(1, "Retreat");
        ...
        case 2:
            if (sShadeFlow.doFlow(this, NULL, 0)) {
                ...
                const int choice = dMsgObject_getSelectCursorPos();  // 0 = Test Your Will, 1 = Retreat
                // Clear the select-word COUNT so the next message box (e.g. the
                // game-over Retry menu) doesn't inherit our stale 2-way select.
                dMsgObject_setSelectWordFlag(0);

                if (choice == 0) {
                    // Test Your Will: warp to the Hero's Shade arena (F_SP200).
                    // TODO(Milestone B+): swap for the cinematic lunge/howl warp.
                    dComIfGp_setNextStage("F_SP200", 0, 0, -1);
                }
                // Retreat (choice 1): close the box and return to idle.
                dComIfGp_event_reset();
                mMode = 3;
                rv = TRUE;
            }
...
BOOL daAlbwShadeBossWolf_c::test(void* param_1) {
    switch (mMode) {
        case 0:
            speedF = 0.0f;
            speed.setall(0.0f);
...
s16 daAlbwShadeBossWolf_c::getGroundSlope(dBgS_ObjAcch& i_acch, s16 param_2) {
    cM3dGPla plane;
...
static int daAlbwShadeBossWolf_Create(void* a_this) {
    return static_cast<daAlbwShadeBossWolf_c*>(a_this)->create();
}

static int daAlbwShadeBossWolf_Delete(void* a_this) {
    return static_cast<daAlbwShadeBossWolf_c*>(a_this)->Delete();
}

static int daAlbwShadeBossWolf_Execute(void* a_this) {
    return static_cast<daAlbwShadeBossWolf_c*>(a_this)->Execute();
}

static int daAlbwShadeBossWolf_Draw(void* a_this) {
    return static_cast<daAlbwShadeBossWolf_c*>(a_this)->Draw();
}

static int daAlbwShadeBossWolf_IsDelete(void* a_this) {
    return 1;
}

AUDIO_INSTANCES;

static DUSK_CONST actor_method_class daAlbwShadeBossWolf_MethodTable = {
    (process_method_func)daAlbwShadeBossWolf_Create,
    (process_method_func)daAlbwShadeBossWolf_Delete,
    (process_method_func)daAlbwShadeBossWolf_Execute,
    (process_method_func)daAlbwShadeBossWolf_IsDelete,
    (process_method_func)daAlbwShadeBossWolf_Draw,
};

DUSK_PROFILE actor_process_profile_definition DUSK_CONST g_profile_ALBW_SHADE_BOSS_WOLF = {
    /* Layer ID     */ fpcLy_CURRENT_e,
    /* List ID      */ 7,
    /* List Prio    */ fpcPi_CURRENT_e,
    /* Proc Name    */ fpcNm_ALBW_SHADE_BOSS_WOLF_e,
    /* Proc SubMtd  */ &g_fpcLf_Method.base,
    /* Size         */ sizeof(daAlbwShadeBossWolf_c),
    /* Size Other   */ 0,
    /* Parameters   */ 0,
    /* Leaf SubMtd  */ &g_fopAc_Method.base,
    /* Draw Prio    */ fpcDwPi_ALBW_SHADE_BOSS_WOLF_e,
    /* Actor SubMtd */ &daAlbwShadeBossWolf_MethodTable,
