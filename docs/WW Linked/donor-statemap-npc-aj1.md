# Donor state map — `D:\XXXXXXX\WW DP\src\d\actor\d_a_npc_aj1.cpp`
...
- L365 `void daNpc_Aj1_c::set_action(int (daNpc_Aj1_c::*)(void*), void*) {`

(1 set_action transitions)

## NPC idiom — action-method state roster
`set_action`, `wait_action1`, `wait_action2`
