...
| # | Owner | Step | Blocked by |
|---|---|---|---|
| 11 | **Bridge** + **Engine** | Build-exclusion configuration, gated by the generated manifest. Covers stacks immediately; **partial by definition until 19**. | 2 (scope from 8) |
