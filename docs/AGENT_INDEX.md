...
| **WW plugin Outset retrace** (vanilla + `.dusk`) | [state/ww-plugin-outset.md](state/ww-plugin-outset.md) | Engine/Bridge live tip. 2026-08-19: TP-ratio overlay that blacked the island **reverted**. Pale write restored. Cloud UV kept. |
