id:            sc5d0a48a
symbols:       UNDERIVED
tu:            src/d/ext_seq/ja1_jastrackinterrupt.cpp
...
provenance:    see-file
citations:
  - src/d/ext_seq/ja1_jastrackinterrupt.cpp KIT-LINEAGE native-port (read 2026-08-16)
...
notes: |
  ADJUDICATED PLUGIN from KIT-LINEAGE `native-port`: a donor actor reached through
  the plugin's profile path, not by a receiver edit.
