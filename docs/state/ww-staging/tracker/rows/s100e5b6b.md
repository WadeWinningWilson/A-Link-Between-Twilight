id:            s100e5b6b
symbols:       g_profile_WW_SHUTTER, g_profile_WW_SHUTTER2, daWwShutter2_c, daWwShutter_c
tu:            src/d/actor/d_a_ww_shutter.cpp
...
provenance:    see-file
citations:
  - src/d/actor/d_a_ww_shutter.cpp KIT-LINEAGE native-port (read 2026-08-16)
