# Claude instructions — A Link Between Dusklight
...
Orient via [docs/AGENT_INDEX.md](docs/AGENT_INDEX.md) (live state map +
multi-agent protocol). Shared agent rules: [AGENTS.md](AGENTS.md).
