...
entry names (BG/collision registration, room identity, ...), follow the
entry's sanctioned path; never self-approve an exception — escalate to the
user. Then orient via docs/AGENT_INDEX.md.
